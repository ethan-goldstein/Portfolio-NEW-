/* Gradual edge blur (from reactbits.dev/animations/gradual-blur).
   Stacks masked backdrop-filter layers so content melts into blur at an
   edge of its container (or the page). */
